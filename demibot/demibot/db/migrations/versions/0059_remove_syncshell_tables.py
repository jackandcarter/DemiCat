"""0059_remove_syncshell_tables

Revision ID: 0059_remove_syncshell_tables
Revises: 0058_drop_syncshell_tables
...
revision: str = "0059_remove_syncshell_tables"
down_revision: Union[str, None] = "0058_drop_syncshell_tables"
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

SYNC_SHELL_OBJECTS: Sequence[tuple[str, tuple[str, ...]]] = (
    ("syncshell_transfer_budgets", ()),
    (
        "syncshell_presence",
        ("ix_syncshell_presence_member_user_id", "ix_syncshell_presence_user_id"),
    ),
    (
        "syncshell_members",
        ("ix_syncshell_members_member_user_id", "ix_syncshell_members_user_id"),
    ),
    (
        "syncshell_invites",
        (
    ...
    (
        "syncshell_pairings",
        ("ix_syncshell_pairings_expires_at", "ix_syncshell_pairings_token"),
    ),
)
...
def upgrade() -> None:
    ...
    # IMPORTANT: do not drop indexes explicitly; tables may have FKs that require them.
    # Dropping the table implicitly removes its FKs and indexes.
    for table_name, _ in SYNC_SHELL_OBJECTS:
